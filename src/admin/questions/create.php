...
<head>
  ...
  <title>POSSE 管理画面ダッシュボード 問題作成</title>
  <!-- スタイルシート読み込み -->
  ...
  <linkhref="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;700&family=Plus+Jakarta+Sans:wght@400;700&display=swap" rel="stylesheet">
